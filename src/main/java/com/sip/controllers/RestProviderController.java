...
@CrossOrigin(origins="*") //autorisé l'accés pour n'importe qui demande /rest/providers
    ...
    public Provider updateProvider(@PathVariable Long providerId, @Valid @RequestBody Provider providerRequest) {
	 ...
	 @GetMapping("/{providerId}")
	    public Provider getProvider(@PathVariable Long providerId) {
	    	...
	    	return p.orElseThrow(() -> new IllegalArgumentException("ProviderId " + providerId + " not found"));
